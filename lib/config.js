...
/*
const path = '{PATH}'; const value = '{VALUE}'; const type = '{TYPE}'; const option = '{OPTION}'; const atPath = `(at '${path}')`;
...
Object.keys(errorSrc).forEach((name) => {
  Object.defineProperty(errors, name, {
    get: () => errorSrc[name],
    set: (val) => {
      if (!isType(val, 'String')) throw new Error('errors are required to be strings');
